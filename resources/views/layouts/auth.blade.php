                ...
                <div class="header-center">
                    <nav id="sideNav" class="mainmenu-nav navbar-example2 d-none d-xl-block onepagenav">
                        ...
                        <ul class="primary-menu nav nav-pills">
                            <li class="nav-item"><a class="nav-link" href="{{ route('main.index') }}#home">Home</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('main.index') }}#features">Features</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('main.index') }}#portfolio">Portfolio</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('main.index') }}#resume">Resume</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('main.index') }}#blog">blog</a></li>
                            <li class="nav-item"><a class="nav-link" href="{{ route('main.index') }}#contacts">Contact</a></li>
                        </ul>
                        <!-- End Mainmanu Nav -->
                    </nav>
        ...
        <div class="inner">
            ...
            <div class="content">
                <ul class="primary-menu nav nav-pills onepagenav">
                    <li class="nav-item"><a class="nav-link smoth-animation active" href="{{ route('main.index') }}#home">Home</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="{{ route('main.index') }}#features">Features</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="{{ route('main.index') }}#portfolio">Portfolio</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="{{ route('main.index') }}#resume">Resume</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="{{ route('main.index') }}#blog">blog</a></li>
                    <li class="nav-item"><a class="nav-link smoth-animation" href="{{ route('main.index') }}#contacts">Contact</a></li>
                </ul>
                <!-- social sharea area -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="footer-area text-center">
                        ...
                        <p class="description mt--30">© 2022. All rights reserved by <a target="_blank" href="{{ route('main.index') }}"> {{ config('app.name') }} </a></p>
                    </div>
                </div>
            </div>
        </div>
