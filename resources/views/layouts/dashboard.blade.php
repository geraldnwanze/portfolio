            ...
            <div class="side-header-inner custom-scroll">
                ...
                <nav class="side-header-menu" id="side-header-menu">
                    <ul>
                        ...
                        <li>
                            <a href=""><i class="fa fa-university"></i> <span>Account</span></a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href=""><i class="fa fa-exchange"></i> <span>Transfers</span></a>
                        </li>
                        <li class="has-sub-menu"><a href="#"><i class="fa fa-history"></i> <span>History</span></a>
                            <ul class="side-header-sub-menu">
                                <li><a href=""><i class="fa fa-level-up"></i><span>Credit History</span></a></li>
                                <li><a href=""><i class="fa fa-level-down"></i><span>Debit History</span></a></li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href=""><i class="fa fa-level-up"></i> <span>Credit History</span></a>
                        </li>
                        <li>
                            <a href=""><i class="fa fa-level-down"></i> <span>Debit History</span></a>
                        </li>
        ...
        <div class="footer-section">
            <div class="container-fluid">
                ...
                <div class="footer-copyright text-center">
                    <p class="text-body-light">2003 &copy; <a href="#">{{ config('app.name') }}</a></p>
                </div>
